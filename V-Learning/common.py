...
#   4.  choose the mode
# MODE = 'human_player'           # Human plays Tetris with keyboard
#MODE = 'ai_player_training'      # AI training mode (collects data and updates model)
#MODE = 'ai_player_watching'      # AI plays with GUI (for demonstration)
MODE = 'ai_player_evaluation'     # AI evaluation mode (no GUI, runs 100 games, saves detailed results)
